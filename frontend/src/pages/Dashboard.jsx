      ...
      <div>
        ...
        {isEmpty && (
          <EmptyState
            ...
            description="No containers have been set up yet. Discover existing Docker containers, or create your first VPN-Proxy or App container to get started."
            actions={[
              {
                label: "Discover existing",
                icon: Search,
                onClick: async () => {
                  setDiscovering(true);
                  setActionProgress({
